...
public class PracticeFormData {
    ...
    public static final String MOBILE = "9998887766";
    public static final String ADDRESS = "Random address";
    public static final String EXPECTED_MAIN_HEADER = "Practice Form";
    public static final String EXPECTED_MODAL_TITLE = "Thanks for submitting the form";
